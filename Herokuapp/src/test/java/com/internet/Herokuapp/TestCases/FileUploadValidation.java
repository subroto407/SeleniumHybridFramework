...
public class FileUploadValidation extends BaseClass {
    ...
    public void fileUpload () throws AWTException {
        ...
        Assert.assertEquals(link, TestData.FILE_UPLOAD_URL);
        System.out.println("Link is valid");
        sleepTime(2000);


        //Validate file name after the upload
        fup.getChooseFileButton().sendKeys(TestData.FILE_UPLOAD_PATH);
        ...
        StringSelection filepath =new StringSelection(TestData.FILE_UPLOAD_PATH);
